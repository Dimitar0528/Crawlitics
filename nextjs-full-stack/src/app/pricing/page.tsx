  ...
  return (
    <div className="relative isolate overflow-hidden bg-white dark:bg-slate-950">
      <div
        ...
        aria-hidden="true">
        <div
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#8085ff] to-[#4506b3] opacity-30 dark:opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <Accordion type="single" collapsible className="w-full mt-8">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-slate-600 dark:text-slate-400 text-base">
                  <strong>Да, абсолютно.</strong> Можете да надстроите, понижите или отмените
                  плана си по всяко време от таблото за управление на вашия
                  акаунт. Пропорционални такси или кредити ще бъдат приложени
                  автоматично.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-slate-900 dark:text-white hover:text-purple-600 dark:hover:text-purple-300 text-lg cursor-pointer">
                ...
                <AccordionContent className="text-slate-600 dark:text-slate-400 text-base">
                  ...
                  продуктите и възможност <strong><i>еднократно</i></strong> да изпробвате някои от Про
                  функциите, като CrawleeBot и известия. <br />
                  С Про плана отключвате
                  пълната, неограничена ценова история и получавате неограничен
                  достъп до всички премиум функционалности на приложението.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-slate-600 dark:text-slate-400 text-base">
                  <strong>Не предлагаме пробен период.</strong> Вместо това, нашият безплатен
                  план е създаден, за да ви позволи да изпробвате основните
                  функционалности на нашата платформа толкова дълго, колкото е
                  необходимо, преди да решите да надстроите за по-разширени
                  данни и функции.
                </AccordionContent>
              </AccordionItem>
