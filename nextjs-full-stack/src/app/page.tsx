...
const processSteps = [
  {
    ...
    description:
      "Нашата интелигентна система, наречена CrawleeBot, систематично обхожда десетки сайтове на онлайн търговци, за да открие всички налични продуктови страници и оферти.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Накрая, събраните данни се анализират, групират и структурират в лесен за разбиране формат от системата. Получавате пълна, ясна и обективна картина на продукта, за да направите най-добрия избор.",
  },
];
